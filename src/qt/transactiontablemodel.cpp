        ...
        cachedNumBlocks(0)
{
    ...
    connect(walletModel->getOptionsModel(), SIGNAL(displayUnitChangedPonyCoin(int)), this, SLOT(updateDisplayUnit()));
}
...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::Generated:
        return tr("Mined");
    case TransactionRecord::DelegatedFee:
        return tr("Delegated fee");
    default:
        return QString();
    }
}
...
QString TransactionTableModel::formatTicker(const TransactionRecord *wtx) const
{
   return QString(COLOR_TICKER[wtx->nColor]);
}

QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed) const
{
    QString str = BitcoinUnits::format(
                     walletModel->getOptionsModel()->getDisplayUnit(wtx->nColor),
                                              wtx->credit + wtx->debit, wtx->nColor);
    if(showUnconfirmed)
    {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::EditRole:
        ...
        case Ticker:
            return QString(COLOR_TICKER[rec->nColor]);
        }
        break;
    case Qt::ToolTipRole:
    ...
    case AmountRole:
        return rec->credit + rec->debit;
    case TickerRole:
        return COLOR_TICKER[rec->nColor];
    case TxIDRole:
