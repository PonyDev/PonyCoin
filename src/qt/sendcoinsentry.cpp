    ...
    model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a PonyCoin address (e.g. brj6Q4FUHXjAzCRb6SB3pXPfuva5xrfjgHY)"));
...
void SendCoinsEntry::setModel(WalletModel *model)
{
    ...
    {
        connect(model->getOptionsModel(), SIGNAL(displayUnitChangedPonyCoin(int)), this,
