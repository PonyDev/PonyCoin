...
const int PUBKEY_ADDRESS = 99;
const int SCRIPT_ADDRESS = 100;
// testnet
const int PUBKEY_ADDRESS_TEST = 1;
const int SCRIPT_ADDRESS_TEST = 132;
...
public:
    ...
    // colors are defined in globalparams.h as enum
    int nColor;
    ...
    bool SetString(const char *psz)
    {
        ...
        std::string address;
        int nCheckColor = PNY_COLOR_NONE;
        {
