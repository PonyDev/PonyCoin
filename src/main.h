...
static const uint256 
     hashGenesisBlock("0x000030a9593c2b09013c8fcbb88bd8c3f5444d9ac5a207d754a183f7db2e4f56");
static const uint256 
     hashGenesisBlockTestNet("0x0002c34c376c6588b202f8b4ffa6d339e9f27b1e2fc8f672161886fb3db6ba2a");
...
public:
    ...
    bool IsUncolored()
    {
        return (nColor == (int) PNY_COLOR_NONE);
    }
...
public:
    ...
    {
        // ponycoin: the coin mint transaction is marked with
        //    first input null
...
public:
    ...
    // Total PONY money is tracked for fee scavenging PoW
    ...
    CBlockIndex()
    {
        ...
        nChainTrust = 0;
        nCoinbaseColor = (int) PNY_COLOR_NONE;
        nFlags = 0;
        bnStakeModifier = 0;
	...
	vMoneySupply.assign(N_COLORS, 0);
        ...
        else
        {
            prevoutStake.SetNull();
            nStakeTime = 0;
            nStakeColor = (int) PNY_COLOR_NONE;
        }
